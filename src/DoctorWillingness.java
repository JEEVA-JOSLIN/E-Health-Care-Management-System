 ...
 * @author lenovo
 */
public class DoctorWillingness extends javax.swing.JFrame {

    /**
     * Creates new form DoctorWillingness
     */
    public DoctorWillingness() {
        initComponents();
        try
        {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try 
        {
           ...
           String nme=name.getText();
            ...
            String q1 = "insert into doctor(gid,name,specialization,location,noc,rating,email)values(?,?,?,?,?,?,?)";
            PreparedStatement  ps1=con.prepareStatement(q1,Statement.RETURN_GENERATED_KEYS);
            ps1.setString(1,gid.getText());
            ps1.setString(2,name.getText());
            ps1.setString(3,special.getText());
            ps1.setString(4,location.getText());
            ps1.setInt(5,n);
            ps1.setFloat(6,r);
            ps1.setString(7,email.getText());
            ps1.executeUpdate();
            String sql="select * from doctor WHERE gid='"+ gid.getText()+"' ";
            ResultSet rs=stmt.executeQuery(sql);
            rs.next();
            String i=String.valueOf(rs.getInt("dno"));
            JOptionPane.showMessageDialog(null,"THANK YOU FOR YOUR WILLINGNESS");
            JOptionPane.showMessageDialog(null,"YOUR ID IS "+i);
        }
        catch(Exception e)
        {
...
dispose();// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoctorWillingness.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DoctorWillingness().setVisible(true);
            }
        });
    }
